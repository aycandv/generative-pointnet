...
def pointnet_classification_loss(outputs, labels, m3x3, m64x64, alpha=0.0001):
    ...
    Returns:
        (Variable) loss
    """
    return _pointnet_loss(outputs, labels, m3x3, m64x64, torch.nn.CrossEntropyLoss, alpha)
...
def pointnet_generative_loss(outputs, labels, m3x3, m64x64, alpha=0.0001):
    ...
    Returns:
        (Variable) loss
    """
    return _pointnet_loss(outputs, labels, m3x3, m64x64, torch.nn.MSELoss, alpha)
